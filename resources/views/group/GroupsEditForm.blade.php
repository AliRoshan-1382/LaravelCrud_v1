    ...
    <div class="row justify-content-center align-items-center">
        <div class="col-3">
            <div class="container mt-3">
              ...
              <form action="{{ url('group/GroupsEdit') }}" method="POST">
                @csrf
                <div class="form-floating mb-3 mt-3 ">
                  <input type="text" class="form-control" value="{{ $id }}" id="id" placeholder="Enter email" name="id" readonly>
                  <label for="pwd">Id</label>
                </div>

                <div class="form-floating mt-3 mb-3">
                  <input type="text" class="form-control" value="{{ $Gname }}" id="Gname" placeholder="...Type Your New Gname" name="Gname" required>
