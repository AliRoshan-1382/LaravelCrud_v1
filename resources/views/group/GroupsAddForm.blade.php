          ...
          <div class="flex">
            ...
            <div class="card card-primary mt-5">
              <div class="card-header">
                <h3 class="card-title">ثبت اطلاعات گروه</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="row justify-content-center align-items-center">
                  <div class="col-md-2">
                    <div class="card card-primary mt-5">
                      <form role="form" action="{{ url('group/GroupsAdd') }}" method="post">
                        @csrf
                        <div class="card-body">
                          <div class="form-floating mb-3 mt-3">
                            <input type="text" class="form-control" name="group" id="group" placeholder="نام گروه را وارد کنید" required>
